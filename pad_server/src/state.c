...
static const struct actuator_info ACTUATORS[] = {
    {.id = ID_XV1, .gpio = true, .priv = {.dev = "/dev/gpio0"}},
    {.id = ID_XV2, .gpio = true, .priv = {.dev = "/dev/gpio1"}},
    {.id = ID_XV3, .gpio = true, .priv = {.dev = "/dev/gpio2"}},
    {.id = ID_XV4, .gpio = true, .priv = {.dev = "/dev/gpio3"}},
    {.id = ID_XV5, .gpio = true, .priv = {.dev = "/dev/gpio4"}},
    {.id = ID_XV6, .gpio = true, .priv = {.dev = "/dev/gpio5"}},
    {.id = ID_XV7, .gpio = true, .priv = {.dev = "/dev/gpio6"}},
    {.id = ID_XV8, .gpio = true, .priv = {.dev = "/dev/gpio11"}},
    {.id = ID_XV9, .gpio = true, .priv = {.dev = "/dev/gpio10"}},
    {.id = ID_XV10, .gpio = true, .priv = {.dev = "/dev/gpio9"}},
    {.id = ID_XV11, .gpio = true, .priv = {.dev = "/dev/gpio8"}},
    {.id = ID_XV12, .gpio = true, .priv = {.dev = "/dev/gpio28"}},
    {.id = ID_IGNITER, .gpio = true, .priv = {.dev = "/dev/gpio7"}},
    {.id = ID_DUMP,
     .gpio = false,
     .priv = {.pwm =
                  {
